...
/*
 * TODO:
 * This file was copied from the droid-util-51.h, and I compared
 * the 22/system/audio.h with 23/system/audio.h, added some new Macro with
 * the "This was added in Android 6.0" comments.
 * we need to improve it more depend on the requirement of Android 6.0.
 */

#ifndef _DROID_UTIL_V60_H_
#define _DROID_UTIL_V60_H_
...
struct string_conversion string_conversion_table_input_device[] = {
    ...
    STRING_ENTRY(AUDIO_DEVICE_IN_IP),                  // This was added in Android 6.0
#ifdef QCOM_HARDWARE
...
struct string_conversion string_conversion_table_input_device_fancy[] = {
    ...
    { AUDIO_DEVICE_IN_IP,                       "input-ip" },                   // This was added in Android 6.0
#ifdef QCOM_HARDWARE
#ifdef DROID_AUDIO_HAL_SECONDARY_MIC
...
struct string_conversion string_conversion_table_output_flag[] = {
    ...
    STRING_ENTRY(AUDIO_OUTPUT_FLAG_TTS),                // This was added in Android 6.0
    STRING_ENTRY(AUDIO_OUTPUT_FLAG_RAW),                // This was added in Android 6.0
    STRING_ENTRY(AUDIO_OUTPUT_FLAG_SYNC),               // This was added in Android 6.0
...
struct string_conversion string_conversion_table_input_flag[] = {
    ...
    STRING_ENTRY(AUDIO_INPUT_FLAG_RAW),                 // This was added in Android 6.0
    STRING_ENTRY(AUDIO_INPUT_FLAG_SYNC),                // This was added in Android 6.0
    { 0, NULL }
};
...
struct string_conversion string_conversion_table_format[] = {
    ...
    STRING_ENTRY(AUDIO_FORMAT_DTS),             // This was added in Android 6.0
    STRING_ENTRY(AUDIO_FORMAT_DTS_HD),          // This was added in Android 6.0
